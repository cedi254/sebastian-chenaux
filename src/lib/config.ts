export const siteConfig = {
  ...
  location: {
    name: "MCS Training",
    website: "https://www.mcs-training.ch/",
    note: "Personal Training mit Sebastian bei MCS Training. Den genauen Treffpunkt vereinbaren wir persönlich.",
    verifiedOn: "2026-09-07",
    studios: [
      {
        name: "Zürichberg",
        street: "Kurhausstrasse 20",
        city: "8032 Zürich",
        map: "https://www.google.com/maps/search/?api=1&query=Kurhausstrasse+20+8032+Z%C3%BCrich",
      },
      {
        name: "Altstetten",
        street: "Badenerstrasse 557",
        city: "8048 Zürich",
        map: "https://www.google.com/maps/search/?api=1&query=Badenerstrasse+557+8048+Z%C3%BCrich",
      },
    ],
  },
};
